        ...
        <Stack padding={2} width={600}
          ...
          <Stack marginTop={7} alignItems={"center"}>
            ...
            <Box sx={{display: 'flex', alignItems: 'flex-end'}}>
              ...
              <Button sx={{marginLeft: 2, marginRight: 2, color: "#F3EED9"}}
                      variant={"contained"} color={"inherit"}
              >
                <Typography onClick={checkEmailHandler} fontFamily={"Oswald"}
                            color={"black"}>check</Typography>
                <CheckIcon sx={{marginLeft: 2}} color={"success"}/>
              </Button>
              {/* 하단 형식 */}
            </Box>
            ...
            {/* 비밀번호 체크 */}
            <Box sx={{display: 'flex', alignItems: 'flex-end'}}>
              <FormControl sx={{m: 1, width: 350, marginLeft: 11}}
                           variant="outlined">
                <InputLabel
                    htmlFor="outlined-adornment-password">Password</InputLabel>
                <OutlinedInput
                    ...
                    color={"success"}
                    onChange={changPasswordCheckHandler}
                    id="outlined-adornment-password"
                    type={showPassword ? 'text' : 'password'}
                    endAdornment={
                      <InputAdornment position="end">
              ...
              <Button sx={{
                ...
                marginRight: 3
                      ...
                      variant={"contained"} color={"inherit"}
              >
                <Typography onClick={checkPasswordHandler} fontFamily={"Oswald"}
                            color={"black"}>Check</Typography>
                <CheckIcon sx={{marginLeft: 2}} color={"success"}/>
              </Button>
            </Box>
            ...
            {/* 카카오 로그인부분 */}
            <a href={`https://kauth.kakao.com/oauth/authorize?client_id=e25d4a5bece3a1aa5a8b3e1ea3501c82&redirect_uri=http://localhost:8080/oauth/callback/kakao&response_type=code`}>
