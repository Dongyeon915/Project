...
import {
  ...
  plusIntervalCountActionCreator,
...
import {
  fetchPomodoroCoutZero,
  fetchPomodoroData
} from "../../../redux/api/pomodoroAPI";
...
export default function PomodoroCopy() {
  ...
  useEffect(() => {
    fetchPomodoroData(accessToken,authInfo,dispatch)
  }, [])
  ...
  useEffect(() => {
    if (pomodoro.config.countValue === 0) {
      ...
      fetchPomodoroCoutZero(accessToken, authInfo, pomodoro, apiURL)
